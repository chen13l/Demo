...
// End Cross Module References
	...
	DEFINE_FUNCTION(UMenu::execMenuSetup)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->MenuSetup(Z_Param_NumOfPublicConnections,Z_Param_TypeOfMatch,Z_Param_LobbyPath);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 3665669127
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 1938129255
		{ &Z_Construct_UFunction_UMenu_OnDestroySession, "OnDestroySession" }, // 349956894
		{ &Z_Construct_UFunction_UMenu_OnHostButtonClicked, "OnHostButtonClicked" }, // 2117496567
		{ &Z_Construct_UFunction_UMenu_OnJoinButtonClicked, "OnJoinButtonClicked" }, // 3730889586
		{ &Z_Construct_UFunction_UMenu_OnStartSession, "OnStartSession" }, // 3749138611
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Demo_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 1540589509U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Demo_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_1478621616(TEXT("/Script/MultiplayerSessions"),
